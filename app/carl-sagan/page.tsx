...
const downloadableResources = [
  {
    ...
    url: 'https://archive.org/download/cosmos-carl-sagan/cosmos-carl-sagan.pdf',
    language: 'Español',
    format: 'PDF',
    pages: 365,
  ...
  },
  {
    ...
    url: 'https://archive.org/download/el-mundo-y-sus-demonios-sagan/el-mundo-y-sus-demonios-sagan.pdf',
    language: 'Español',
    format: 'PDF',
    pages: 457,
  ...
  },
  {
    ...
    url: 'https://archive.org/download/pale-blue-dot-sagan/pale-blue-dot-sagan.pdf',
    language: 'Español',
    format: 'PDF',
    pages: 429,
  ...
  },
  {
    ...
    url: 'https://archive.org/download/contacto-carl-sagan/contacto-carl-sagan.pdf',
    language: 'Español',
    format: 'PDF',
    pages: 432,
  ...
  },
  {
    ...
    url: 'https://archive.org/download/los-dragones-del-eden-sagan/los-dragones-del-eden-sagan.pdf',
    language: 'Español',
    format: 'PDF',
    pages: 263,
  ...
  },
  {
    ...
    url: 'https://archive.org/download/el-cerebro-de-broca-sagan/el-cerebro-de-broca-sagan.pdf',
    language: 'Español',
    format: 'PDF',
    pages: 347,
